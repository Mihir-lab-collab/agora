        ...
        public static string GenerateJwtToken(UserIdentityData objUserData)
        {
            try
            {
                ...
                var tokenDescriptor = new SecurityTokenDescriptor
                {
                    ...
                    {
                         new Claim(ClaimTypes.Name, objUserData.EmpName),
                         new Claim(ClaimTypes.Email, objUserData.EmpEmail),
                         new Claim(ClaimTypes.Role, objUserData.SkillId.ToString()),
                         new Claim(ClaimTypes.NameIdentifier, objUserData.EmpID),
            }),

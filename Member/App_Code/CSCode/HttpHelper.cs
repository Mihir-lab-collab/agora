...
public static class HttpHelper
{
    ...
    /// <Author>Samer Abu Rabie</Author>
    private static String PreparePOSTForm(string url, string data, string IsAdmin)
    {
        ...
        strForm.Append("<input type=\"hidden\" name=\"EmpId\" value=\"" + data + "\">");
        strForm.Append("<input type=\"hidden\" name=\"IsAdmin\" value=\"" + IsAdmin + "\">");
    ...
    /// <Author>Samer Abu Rabie</Author>
    public static void RedirectAndPOST(Page page, string destinationUrl, string data, string IsAdmin)
    {
        //Prepare the Posting form
        string strForm = PreparePOSTForm(destinationUrl, data, IsAdmin);

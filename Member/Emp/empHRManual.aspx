		...
		<form id="Form1" method="post" runat="server">
			...
			<table id="Table3" cellSpacing="0" cellPadding="2" width="100%" valign=top
				...
				<tr>
                    ...
                    Saturdays: 9:30 AM TO 6:00 PM<br>
				...
				<tr>
                    ...
                    <span style="font-size: 12.0pt; font-family: Verdana; color: #A2921E">
                    <font size="2">
                    <span style="font-family: Verdana; color: #A2921E">Paid 
                    ...
                    <ul>
                      ...
                      may be accumulated upto 120 days in the entire service 
                      ...
                      <p class="MsoNormal">
                      <span style="font-family: Verdana; color: #A2921E">
                      <font size="2">Application for P.L shall be submitted at 
                      ...
                      <p class="MsoNormal">
                      <span style="font-family: Verdana; color: #A2921E">
                      <font size="2">An employee on P.L. may be recalled from 
                    ...
                    <ul>
                      <li>
                      <p class="MsoNormal" style="text-align: justify; margin-left: .5in">
                      <font size="2" color="#A2921E">
                      <span style="font-family: Verdana">Leaves more than two 
                      days at a stretch will be permissible only once during the 
                      first year of employment. </span></font></li>
                      <li>
                      <p class="MsoNormal" style="text-align: justify; margin-left: .5in">
                      <span style="font-family: Verdana; color: #A2921E">

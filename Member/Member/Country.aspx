<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Member/Admin.master" CodeFile="Country.aspx.cs" Inherits="Member_Country" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../Member/js/Country.js" type="text/javascript"></script>
    <%--<script type="text/javascript" src="js/Designation.js"></script>--%>
    <script type="text/javascript">
        var gridConfig = "#gridCountry";
        ...
        function GetDataOnInsert(Buttonid) {
            ...
            if (txt != "") {
                document.getElementById("<%=hdnCountry.ClientID%>").value = txt;
    ...
    <div class="content_wrap">
        <div class="gride_table">
            <div class="box_border">
                <div class="grid_head">
                    <asp:Label ID="lblInventoryDetails" Text="Country Name" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label>
        ...
        <div>
            ...
            <table cellpadding="0" cellspacing="0"  border="0" width="100%" class="manage_form">
                ...
                <tr>
                    <th></th>
                    <td>
                        <asp:Button ID="lnkSaveCountry" runat="server" Text="Save" CssClass="small_button red_button open" OnClientClick="javascript:return GetDataOnInsert(this.id);" OnClick="lnkSaveCountry_Click"/>
                        <%--<asp:Button ID="lnkSaveCountry" runat="server" Text="Save" CssClass="small_button red_button open" OnClientClick="javascript:return GetDataOnInsert(this.id);"/>--%>
    ...
    <div id="details-container">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="manage_form">
            ...
            <tr>
                ...
                <td>
                    <input id="txtEditCountryName" type="text" style="width: 300px;" class="k-textbox" required validationmessage="Designation cannot be blank." />

<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Admin.master" AutoEventWireup="true" CodeFile="TDSAdmin.aspx.cs" Inherits="Member_TDSAdmin" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#txtStartDate").kendoDatePicker({
                depth: "decade",
                start: "decade", format: "yyyy", change: DateSelect
            });
            DateSelect();
        });
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                        ...
                        <div class="pdf-page size-a4">
                            ...
                            <table border="1" style="height: 20px; width: 764px; border-collapse: collapse; border: 1px solid black">
                                ...
                                <tr>
                                    <td class="tdPadding">Father Name:</td>
                                    <td>
                                        <input type="text" id="txtFatherName" style="width: 97%;"  onkeypress="return NameValidation(event,this);"/></td>
                                </tr>
                                <tr>
                                    <td class="tdPadding">PAN:</td>
                                    <td>
                                     
                                        <asp:TextBox ID="txtPanNo" onblur="fnValidatePAN(this);" runat="server" style="width: 97%;" ClientIDMode="Static"></asp:TextBox> 
                                    </td>
                                </tr>
                                 <tr>
 ...
 <table class="signature" border="0" style="width: 183%;">
                                <tr>
                                    <td>Date of signing the form:</td>

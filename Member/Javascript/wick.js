...
function processSmartInput(inputBox) {
    ...
    if (content) {
        ...
        var y = findElementPosY(siw.inputBox)+ siw.inputBox.offsetHeight;

    
        if (navigator.appName == "Microsoft Internet Explorer") {
            siw.floater.style.left = "81px";
            y = (793 - y);   
        }
...
registerSmartInputListeners();
document.write('<table id="smartInputFloater" class="floater" cellpadding="0" cellspacing="0"><tr><td id="smartInputFloaterContent" nowrap="nowrap"><\/td><\/tr><\/table>');
